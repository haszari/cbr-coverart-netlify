...
### some other stuff in this code base that is dormant

- Wrangling DJ mix playlist metadata for [posting radio shows online](https://cartoonbeats.com/beats-reality-radio/).
- Parse Traktor NML (XML) files and convert to easily editable yaml file, which can then be input to a component that lays out a cover art grid image and tracklist.
